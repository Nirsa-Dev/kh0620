      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(resources/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animated fadeInDown">Welcome to <span>CHECKMATE</span></h2>
              <form action="" method="post">
                <div class="input-group mb-3 input-group-lg">
                  <!-- <span class="input-group-text">Large</span> -->
                  <input type="text" class="form-control">
                  <button class="btn-get-started animated fadeInUp scrollto" style="border: none;">Search</button>
                </div>
              </form>
            </div>
          </div>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-10">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="testimonial-item mt-4">
                  <img src="resources/img/testimonials/testimonials-6.jpg" class="testimonial-img" alt="">
                  <h3>Emily Harison</h3>
                  <h4>Store Owner</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
